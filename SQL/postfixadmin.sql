...
INSERT INTO `admin` VALUES ('admin@world.com','$1$4dc48a57$VNI8Gao0WraEPA/jRWGHD/',1,'2016-08-17 11:10:47','2016-08-17 11:11:43',1);
...
INSERT INTO `domain` VALUES ('ALL','',0,0,0,0,'',0,'2016-08-17 11:06:17','2016-08-17 11:06:17',1);
...
INSERT INTO `domain_admins` VALUES ('admin@world.com','ALL','2016-08-17 11:10:47',1);
...
CREATE TABLE `fetchmail` (
  ...
  `date` timestamp NOT NULL DEFAULT '2000-01-01 05:00:00',
  `created` timestamp NOT NULL DEFAULT '2000-01-01 05:00:00',
...
INSERT INTO `log` VALUES ('2016-08-17 11:10:47','SETUP.PHP (192.168.56.1)','','create_admin','admin@world.com'),('2016-08-17 11:11:43','admin@world.com (192.168.56.1)','','edit_admin','admin@world.com');
...
CREATE TABLE `vacation` (
  ...
  `activefrom` timestamp NOT NULL DEFAULT '2000-01-01 05:00:00',
  `activeuntil` timestamp NOT NULL DEFAULT '2000-01-01 05:00:00',
  `cache` text NOT NULL,
  `domain` varchar(255) NOT NULL,
...
-- Dump completed on 2016-08-18  2:40:48
